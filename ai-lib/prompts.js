// Prompts Library
// This module manages system prompts and dynamic prompt generation
...
export function getDynamicTemperature(task, complexity, contextLength = 0) {
  ...
  // Adjust temperature based on context length and complexity
  if (contextLength > 4) {
...
export class PromptManager {
  ...
  // Get token limit for a task and complexity
  getTokenLimit(task, complexity) {
    return getDynamicTokenLimit(task, complexity);
  }

  // Get temperature for a task, complexity, and context
...
// Export default prompt manager instance
